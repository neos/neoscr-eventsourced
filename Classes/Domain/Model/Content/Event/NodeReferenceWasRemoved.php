...
/**
 * A node reference was removed
 */
class NodeReferenceWasRemoved extends AbstractDimensionAwareEvent
{
    /**
     * @var string
     */
     ...
     * @param string $elderSiblingNodeIdentifier
     */
    public function __construct(
        ...
        string $elderSiblingNodeIdentifier = null
    ) {
